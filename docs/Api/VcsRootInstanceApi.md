# Swagger\Client\VcsRootInstanceApi
...
$apiInstance = new Swagger\Client\Api\VcsRootInstanceApi(
...
> \Swagger\Client\Model\VcsRootInstances getAllVcsRootInstances($locator, $fields)
...
# **getFileMetadata**
> \Swagger\Client\Model\\SplFileObject getFileMetadata($path, $vcs_root_instance_locator, $fields)
...
# **getFilesList**
> \Swagger\Client\Model\Files getFilesList($vcs_root_instance_locator, $base_path, $locator, $fields)
...
> \Swagger\Client\Model\Files getFilesListForSubpath($path, $vcs_root_instance_locator, $base_path, $locator, $fields)
...
# **getVcsRootInstance**
> \Swagger\Client\Model\VcsRootInstance getVcsRootInstance($vcs_root_instance_locator, $fields)
...
> \Swagger\Client\Model\Properties getVcsRootInstanceProperties($vcs_root_instance_locator, $fields)
...
> \Swagger\Client\Model\Entries getVcsRootInstanceRepositoryState($vcs_root_instance_locator, $fields)
...
> \Swagger\Client\Model\VcsRootInstances requestPendingChangesCheck($locator, $requestor, $fields)
...
> \Swagger\Client\Model\Entries setVcsRootInstanceRepositoryState($vcs_root_instance_locator, $body, $fields)
...
$vcs_root_instance_locator = "vcs_root_instance_locator_example"; // string | 
$body = new \Swagger\Client\Model\Entries(); // \Swagger\Client\Model\Entries | 
$fields = "fields_example"; // string | 
...
------------- | ------------- | ------------- | -------------
 **vcs_root_instance_locator** | **string**|  |
 **body** | [**\Swagger\Client\Model\Entries**](../Model/Entries.md)|  | [optional]
 **fields** | **string**|  | [optional]
