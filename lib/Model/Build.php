...
class Build implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'links' => '\AceViral\TeamCity\Model\Links',
        'status_text' => 'string',
        'build_type' => '\AceViral\TeamCity\Model\BuildType',
        'comment' => '\AceViral\TeamCity\Model\Comment',
        'tags' => '\AceViral\TeamCity\Model\Tags',
        'pin_info' => '\AceViral\TeamCity\Model\Comment',
        'user' => '\AceViral\TeamCity\Model\User',
        'start_estimate' => 'string',
        'wait_reason' => 'string',
        'finish_estimate' => 'string',
        'running_info' => '\AceViral\TeamCity\Model\ProgressInfo',
        'canceled_info' => '\AceViral\TeamCity\Model\Comment',
        'queued_date' => 'string',
        'start_date' => 'string',
        'finish_date' => 'string',
        'triggered' => '\AceViral\TeamCity\Model\TriggeredBy',
        'last_changes' => '\AceViral\TeamCity\Model\Changes',
        'changes' => '\AceViral\TeamCity\Model\Changes',
        'revisions' => '\AceViral\TeamCity\Model\Revisions',
        'versioned_settings_revision' => '\AceViral\TeamCity\Model\Revision',
        'artifact_dependency_changes' => '\AceViral\TeamCity\Model\BuildChanges',
        'agent' => '\AceViral\TeamCity\Model\Agent',
        'compatible_agents' => '\AceViral\TeamCity\Model\Agents',
        'test_occurrences' => '\AceViral\TeamCity\Model\TestOccurrences',
        'problem_occurrences' => '\AceViral\TeamCity\Model\ProblemOccurrences',
        'artifacts' => '\AceViral\TeamCity\Model\Files',
        'related_issues' => '\AceViral\TeamCity\Model\IssuesUsages',
        'properties' => '\AceViral\TeamCity\Model\Properties',
        'resulting_properties' => '\AceViral\TeamCity\Model\Properties',
        'attributes' => '\AceViral\TeamCity\Model\Entries',
        'statistics' => '\AceViral\TeamCity\Model\Properties',
        'metadata' => '\AceViral\TeamCity\Model\Datas',
        'snapshot_dependencies' => '\AceViral\TeamCity\Model\Builds',
        'artifact_dependencies' => '\AceViral\TeamCity\Model\Builds',
        'custom_artifact_dependencies' => '\AceViral\TeamCity\Model\ArtifactDependencies',
        'settings_hash' => 'string',
        'current_settings_hash' => 'string',
        'modification_id' => 'string',
        'chain_modification_id' => 'string',
        'replacement_ids' => '\AceViral\TeamCity\Model\Items',
        'related' => '\AceViral\TeamCity\Model\Related',
        'triggering_options' => '\AceViral\TeamCity\Model\BuildTriggeringOptions',
        'used_by_other_builds' => 'bool',
        'status_change_comment' => '\AceViral\TeamCity\Model\Comment',
        'vcs_labels' => '\AceViral\TeamCity\Model\VcsLabel[]',
        'detached_from_agent' => 'bool',
        'finish_on_agent_date' => 'string',
        'customized' => 'bool',
        'customization' => '\AceViral\TeamCity\Model\Customizations',
        'locator' => 'string'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'vcs_labels' => null,
        'detached_from_agent' => null,
        'finish_on_agent_date' => null,
        'customized' => null,
        'customization' => null,
        'locator' => null
    ];
    ...
    protected static $setters = [
        ...
        'finish_estimate' => 'setFinishEstimate',
        ...
        'vcs_labels' => 'setVcsLabels',
        'detached_from_agent' => 'setDetachedFromAgent',
        'finish_on_agent_date' => 'setFinishOnAgentDate',
    ...
    protected static $getters = [
        ...
        'finish_estimate' => 'getFinishEstimate',
        ...
        'vcs_labels' => 'getVcsLabels',
        'detached_from_agent' => 'getDetachedFromAgent',
        'finish_on_agent_date' => 'getFinishOnAgentDate',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['unspecified_branch'] = isset($data['unspecified_branch']) ? $data['unspecified_branch'] : null;
        ...
        $this->container['finish_estimate'] = isset($data['finish_estimate']) ? $data['finish_estimate'] : null;
        ...
        $this->container['used_by_other_builds'] = isset($data['used_by_other_builds']) ? $data['used_by_other_builds'] : null;
        $this->container['status_change_comment'] = isset($data['status_change_comment']) ? $data['status_change_comment'] : null;
        $this->container['vcs_labels'] = isset($data['vcs_labels']) ? $data['vcs_labels'] : null;
        $this->container['detached_from_agent'] = isset($data['detached_from_agent']) ? $data['detached_from_agent'] : null;
        $this->container['finish_on_agent_date'] = isset($data['finish_on_agent_date']) ? $data['finish_on_agent_date'] : null;
     ...
     * Gets links
     *
     * @return \AceViral\TeamCity\Model\Links
     */
     ...
     * Sets links
     *
     * @param \AceViral\TeamCity\Model\Links $links links
     *
     * @return $this
     */
     ...
     * Sets comment
     *
     * @param \AceViral\TeamCity\Model\Comment $comment comment
     *
     * @return $this
     */
     ...
     * Sets tags
     *
     * @param \AceViral\TeamCity\Model\Tags $tags tags
     *
     * @return $this
     */
     ...
     * Sets pin_info
     *
     * @param \AceViral\TeamCity\Model\Comment $pin_info pin_info
     *
     * @return $this
     */
    ...
    /**
     * Gets finish_estimate
     *
     * @return string
     */
    public function getFinishEstimate()
    {
        return $this->container['finish_estimate'];
    }

    /**
     * Sets finish_estimate
     *
     * @param string $finish_estimate finish_estimate
     *
     * @return $this
     */
    public function setFinishEstimate($finish_estimate)
    {
        $this->container['finish_estimate'] = $finish_estimate;
     ...
     * Gets running_info
     *
     * @return \AceViral\TeamCity\Model\ProgressInfo
     */
     ...
     * Sets running_info
     *
     * @param \AceViral\TeamCity\Model\ProgressInfo $running_info running_info
     *
     * @return $this
     */
     ...
     * Sets canceled_info
     *
     * @param \AceViral\TeamCity\Model\Comment $canceled_info canceled_info
     *
     * @return $this
     */
     ...
     * Gets triggered
     *
     * @return \AceViral\TeamCity\Model\TriggeredBy
     */
     ...
     * Sets triggered
     *
     * @param \AceViral\TeamCity\Model\TriggeredBy $triggered triggered
     *
     * @return $this
     */
     ...
     * Sets last_changes
     *
     * @param \AceViral\TeamCity\Model\Changes $last_changes last_changes
     *
     * @return $this
     */
     ...
     * Sets changes
     *
     * @param \AceViral\TeamCity\Model\Changes $changes changes
     *
     * @return $this
     */
     ...
     * Gets revisions
     *
     * @return \AceViral\TeamCity\Model\Revisions
     */
     ...
     * Sets revisions
     *
     * @param \AceViral\TeamCity\Model\Revisions $revisions revisions
     *
     * @return $this
     */
     ...
     *
     * @return \AceViral\TeamCity\Model\Revision
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\Revision $versioned_settings_revision versioned_settings_revision
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\BuildChanges $artifact_dependency_changes artifact_dependency_changes
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\Agents $compatible_agents compatible_agents
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\TestOccurrences $test_occurrences test_occurrences
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\ProblemOccurrences $problem_occurrences problem_occurrences
     *
     * @return $this
     */
     ...
     * Sets artifacts
     *
     * @param \AceViral\TeamCity\Model\Files $artifacts artifacts
     *
     * @return $this
     */
     ...
     * Sets related_issues
     *
     * @param \AceViral\TeamCity\Model\IssuesUsages $related_issues related_issues
     *
     * @return $this
     */
     ...
     * Sets properties
     *
     * @param \AceViral\TeamCity\Model\Properties $properties properties
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\Properties $resulting_properties resulting_properties
     *
     * @return $this
     */
     ...
     * Sets attributes
     *
     * @param \AceViral\TeamCity\Model\Entries $attributes attributes
     *
     * @return $this
     */
     ...
     * Sets statistics
     *
     * @param \AceViral\TeamCity\Model\Properties $statistics statistics
     *
     * @return $this
     */
     ...
     * Gets metadata
     *
     * @return \AceViral\TeamCity\Model\Datas
     */
     ...
     * Sets metadata
     *
     * @param \AceViral\TeamCity\Model\Datas $metadata metadata
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\Builds $snapshot_dependencies snapshot_dependencies
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\Builds $artifact_dependencies artifact_dependencies
     *
     * @return $this
     */
     ...
     *
     * @return \AceViral\TeamCity\Model\ArtifactDependencies
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\ArtifactDependencies $custom_artifact_dependencies custom_artifact_dependencies
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\Items $replacement_ids replacement_ids
     *
     * @return $this
     */
     ...
     * Gets related
     *
     * @return \AceViral\TeamCity\Model\Related
     */
     ...
     * Sets related
     *
     * @param \AceViral\TeamCity\Model\Related $related related
     *
     * @return $this
     */
     ...
     *
     * @return \AceViral\TeamCity\Model\BuildTriggeringOptions
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\BuildTriggeringOptions $triggering_options triggering_options
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\Comment $status_change_comment status_change_comment
     *
     * @return $this
     */
     ...
     * Gets vcs_labels
     *
     * @return \AceViral\TeamCity\Model\VcsLabel[]
     */
    public function getVcsLabels()
    {
        return $this->container['vcs_labels'];
    }

    /**
     * Sets vcs_labels
     *
     * @param \AceViral\TeamCity\Model\VcsLabel[] $vcs_labels vcs_labels
     *
     * @return $this
     */
    public function setVcsLabels($vcs_labels)
    {
        $this->container['vcs_labels'] = $vcs_labels;

        return $this;
    }

    /**
     * Gets detached_from_agent
     *
     * @return bool
     */
    public function getDetachedFromAgent()
    {
        return $this->container['detached_from_agent'];
    }

    /**
     * Sets detached_from_agent
     *
     * @param bool $detached_from_agent detached_from_agent
     *
     * @return $this
     */
    public function setDetachedFromAgent($detached_from_agent)
    {
        $this->container['detached_from_agent'] = $detached_from_agent;

        return $this;
    }

    /**
     * Gets finish_on_agent_date
     *
     * @return string
     */
    public function getFinishOnAgentDate()
    {
        return $this->container['finish_on_agent_date'];
    }

    /**
     * Sets finish_on_agent_date
     *
     * @param string $finish_on_agent_date finish_on_agent_date
     *
     * @return $this
     */
    public function setFinishOnAgentDate($finish_on_agent_date)
    {
        $this->container['finish_on_agent_date'] = $finish_on_agent_date;
     ...
     * Sets customized
     *
     * @param bool $customized customized
     *
     * @return $this
     */
     ...
     * Gets customization
     *
     * @return \AceViral\TeamCity\Model\Customizations
     */
     ...
     * Sets customization
     *
     * @param \AceViral\TeamCity\Model\Customizations $customization customization
     *
     * @return $this
     */
