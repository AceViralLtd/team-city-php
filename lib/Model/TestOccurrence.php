...
class TestOccurrence implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'mute' => '\AceViral\TeamCity\Model\Mute',
        'build' => '\AceViral\TeamCity\Model\Build',
        'first_failed' => '\AceViral\TeamCity\Model\TestOccurrence',
        'next_fixed' => '\AceViral\TeamCity\Model\TestOccurrence',
        'invocations' => '\AceViral\TeamCity\Model\TestOccurrences',
        'metadata' => '\AceViral\TeamCity\Model\TestRunMetadata',
        'log_anchor' => 'string'
    ];
     ...
     * Sets mute
     *
     * @param \AceViral\TeamCity\Model\Mute $mute mute
     *
     * @return $this
     */
     ...
     * Sets first_failed
     *
     * @param \AceViral\TeamCity\Model\TestOccurrence $first_failed first_failed
     *
     * @return $this
     */
     ...
     * Sets next_fixed
     *
     * @param \AceViral\TeamCity\Model\TestOccurrence $next_fixed next_fixed
     *
     * @return $this
     */
     ...
     * Sets invocations
     *
     * @param \AceViral\TeamCity\Model\TestOccurrences $invocations invocations
     *
     * @return $this
     */
     ...
     * Gets metadata
     *
     * @return \AceViral\TeamCity\Model\TestRunMetadata
     */
     ...
     * Sets metadata
     *
     * @param \AceViral\TeamCity\Model\TestRunMetadata $metadata metadata
     *
     * @return $this
     */
