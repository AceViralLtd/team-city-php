...
class BuildType implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'templates' => '\AceViral\TeamCity\Model\BuildTypes',
        'template' => '\AceViral\TeamCity\Model\BuildType',
        'vcs_root_entries' => '\AceViral\TeamCity\Model\VcsRootEntries',
        'settings' => '\AceViral\TeamCity\Model\Properties',
        'parameters' => '\AceViral\TeamCity\Model\Properties',
        'steps' => '\AceViral\TeamCity\Model\Steps',
        'features' => '\AceViral\TeamCity\Model\Features',
        'triggers' => '\AceViral\TeamCity\Model\Triggers',
        'snapshot_dependencies' => '\AceViral\TeamCity\Model\SnapshotDependencies',
        'artifact_dependencies' => '\AceViral\TeamCity\Model\ArtifactDependencies',
        'agent_requirements' => '\AceViral\TeamCity\Model\AgentRequirements',
        'branches' => '\AceViral\TeamCity\Model\Branches',
        'builds' => '\AceViral\TeamCity\Model\Builds',
        'investigations' => '\AceViral\TeamCity\Model\Investigations',
        'compatible_agents' => '\AceViral\TeamCity\Model\Agents',
        'vcs_root_instances' => '\AceViral\TeamCity\Model\VcsRootInstances',
     ...
     * Sets templates
     *
     * @param \AceViral\TeamCity\Model\BuildTypes $templates templates
     *
     * @return $this
     */
     ...
     * Sets template
     *
     * @param \AceViral\TeamCity\Model\BuildType $template template
     *
     * @return $this
     */
     ...
     *
     * @return \AceViral\TeamCity\Model\VcsRootEntries
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\VcsRootEntries $vcs_root_entries vcs_root_entries
     *
     * @return $this
     */
     ...
     * Sets settings
     *
     * @param \AceViral\TeamCity\Model\Properties $settings settings
     *
     * @return $this
     */
     ...
     * Sets parameters
     *
     * @param \AceViral\TeamCity\Model\Properties $parameters parameters
     *
     * @return $this
     */
     ...
     * Gets steps
     *
     * @return \AceViral\TeamCity\Model\Steps
     */
     ...
     * Sets steps
     *
     * @param \AceViral\TeamCity\Model\Steps $steps steps
     *
     * @return $this
     */
     ...
     * Gets features
     *
     * @return \AceViral\TeamCity\Model\Features
     */
     ...
     * Sets features
     *
     * @param \AceViral\TeamCity\Model\Features $features features
     *
     * @return $this
     */
     ...
     * Gets triggers
     *
     * @return \AceViral\TeamCity\Model\Triggers
     */
     ...
     * Sets triggers
     *
     * @param \AceViral\TeamCity\Model\Triggers $triggers triggers
     *
     * @return $this
     */
     ...
     *
     * @return \AceViral\TeamCity\Model\SnapshotDependencies
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\SnapshotDependencies $snapshot_dependencies snapshot_dependencies
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\ArtifactDependencies $artifact_dependencies artifact_dependencies
     *
     * @return $this
     */
     ...
     *
     * @return \AceViral\TeamCity\Model\AgentRequirements
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\AgentRequirements $agent_requirements agent_requirements
     *
     * @return $this
     */
     ...
     * Gets branches
     *
     * @return \AceViral\TeamCity\Model\Branches
     */
     ...
     * Sets branches
     *
     * @param \AceViral\TeamCity\Model\Branches $branches branches
     *
     * @return $this
     */
     ...
     * Sets builds
     *
     * @param \AceViral\TeamCity\Model\Builds $builds builds
     *
     * @return $this
     */
     ...
     * Sets investigations
     *
     * @param \AceViral\TeamCity\Model\Investigations $investigations investigations
     *
     * @return $this
     */
     ...
     *
     * @param \AceViral\TeamCity\Model\VcsRootInstances $vcs_root_instances vcs_root_instances
     *
     * @return $this
     */
