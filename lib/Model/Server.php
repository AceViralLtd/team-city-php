...
class Server implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'role' => 'string',
        'web_url' => 'string',
        'projects' => '\AceViral\TeamCity\Model\Href',
        'vcs_roots' => '\AceViral\TeamCity\Model\Href',
        'builds' => '\AceViral\TeamCity\Model\Href',
        'users' => '\AceViral\TeamCity\Model\Href',
        'user_groups' => '\AceViral\TeamCity\Model\Href',
        'agents' => '\AceViral\TeamCity\Model\Href',
        'build_queue' => '\AceViral\TeamCity\Model\Href',
        'agent_pools' => '\AceViral\TeamCity\Model\Href',
        'investigations' => '\AceViral\TeamCity\Model\Href',
        'mutes' => '\AceViral\TeamCity\Model\Href',
     ...
     * Sets projects
     *
     * @param \AceViral\TeamCity\Model\Href $projects projects
     *
     * @return $this
     */
     ...
     * Sets vcs_roots
     *
     * @param \AceViral\TeamCity\Model\Href $vcs_roots vcs_roots
     *
     * @return $this
     */
     ...
     * Sets builds
     *
     * @param \AceViral\TeamCity\Model\Href $builds builds
     *
     * @return $this
     */
     ...
     * Sets users
     *
     * @param \AceViral\TeamCity\Model\Href $users users
     *
     * @return $this
     */
     ...
     * Sets user_groups
     *
     * @param \AceViral\TeamCity\Model\Href $user_groups user_groups
     *
     * @return $this
     */
     ...
     * Sets agents
     *
     * @param \AceViral\TeamCity\Model\Href $agents agents
     *
     * @return $this
     */
     ...
     * Sets build_queue
     *
     * @param \AceViral\TeamCity\Model\Href $build_queue build_queue
     *
     * @return $this
     */
     ...
     * Sets agent_pools
     *
     * @param \AceViral\TeamCity\Model\Href $agent_pools agent_pools
     *
     * @return $this
     */
     ...
     * Sets investigations
     *
     * @param \AceViral\TeamCity\Model\Href $investigations investigations
     *
     * @return $this
     */
     ...
     * Sets mutes
     *
     * @param \AceViral\TeamCity\Model\Href $mutes mutes
     *
     * @return $this
     */
