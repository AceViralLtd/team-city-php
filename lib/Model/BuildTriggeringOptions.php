...
class BuildTriggeringOptions implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'rebuild_dependencies' => '\AceViral\TeamCity\Model\BuildTypes'
    ];
    ...
    {
        $this->container['clean_sources'] = isset($data['clean_sources']) ? $data['clean_sources'] : null;
        $this->container['clean_sources_in_all_dependencies'] = isset($data['clean_sources_in_all_dependencies']) ? $data['clean_sources_in_all_dependencies'] : null;
        $this->container['rebuild_all_dependencies'] = isset($data['rebuild_all_dependencies']) ? $data['rebuild_all_dependencies'] : null;
        $this->container['rebuild_failed_or_incomplete_dependencies'] = isset($data['rebuild_failed_or_incomplete_dependencies']) ? $data['rebuild_failed_or_incomplete_dependencies'] : null;
        $this->container['queue_at_top'] = isset($data['queue_at_top']) ? $data['queue_at_top'] : null;
        $this->container['freeze_settings'] = isset($data['freeze_settings']) ? $data['freeze_settings'] : null;
        $this->container['tag_dependencies'] = isset($data['tag_dependencies']) ? $data['tag_dependencies'] : null;
     ...
     *
     * @param \AceViral\TeamCity\Model\BuildTypes $rebuild_dependencies rebuild_dependencies
     *
     * @return $this
     */
