...
class LicensingData implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'agents_left' => 'int',
        'license_keys' => '\AceViral\TeamCity\Model\LicenseKeys'
    ];
    ...
    const SERVER_LICENSE_TYPE_EVALUATION = 'evaluation';
    const SERVER_LICENSE_TYPE_EAP = 'eap';
    const SERVER_LICENSE_TYPE_OPEN_SOURCE = 'open_source';
    const SERVER_LICENSE_TYPE_COMMERCIAL = 'commercial';
    const SERVER_LICENSE_TYPE_ENTERPRISE = 'enterprise';
    const SERVER_LICENSE_TYPE_PROFESSIONAL = 'professional';
     ...
     * @return string[]
     */
    public function getServerLicenseTypeAllowableValues()
    {
        return [
            self::SERVER_LICENSE_TYPE_EVALUATION,
            self::SERVER_LICENSE_TYPE_EAP,
            self::SERVER_LICENSE_TYPE_OPEN_SOURCE,
            self::SERVER_LICENSE_TYPE_COMMERCIAL,
            self::SERVER_LICENSE_TYPE_ENTERPRISE,
            self::SERVER_LICENSE_TYPE_PROFESSIONAL,
        ];
    }
    ...
    {
        $this->container['license_use_exceeded'] = isset($data['license_use_exceeded']) ? $data['license_use_exceeded'] : null;
        $this->container['max_agents'] = isset($data['max_agents']) ? $data['max_agents'] : null;
        $this->container['unlimited_agents'] = isset($data['unlimited_agents']) ? $data['unlimited_agents'] : null;
        $this->container['max_build_types'] = isset($data['max_build_types']) ? $data['max_build_types'] : null;
        $this->container['unlimited_build_types'] = isset($data['unlimited_build_types']) ? $data['unlimited_build_types'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getServerLicenseTypeAllowableValues();
        if (!is_null($this->container['server_license_type']) && !in_array($this->container['server_license_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'server_license_type', must be one of '%s'",
    ...
    {
        $allowedValues = $this->getServerLicenseTypeAllowableValues();
        if (!is_null($server_license_type) && !in_array($server_license_type, $allowedValues, true)) {
     ...
     * Sets license_keys
     *
     * @param \AceViral\TeamCity\Model\LicenseKeys $license_keys license_keys
     *
     * @return $this
     */
