...
class CloudInstanceApi
{
     ...
     * @return \AceViral\TeamCity\Model\CloudImages
     */
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\CloudImages, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllCloudImagesWithHttpInfo($locator = null, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\CloudImages';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AceViral\TeamCity\Model\CloudImages',
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\CloudInstances, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllCloudInstancesWithHttpInfo($locator = null, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\CloudInstances';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AceViral\TeamCity\Model\CloudInstances',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AceViral\TeamCity\Model\CloudProfiles
     */
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\CloudProfiles, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllCloudProfilesWithHttpInfo($locator = null, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\CloudProfiles';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AceViral\TeamCity\Model\CloudProfiles',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\CloudImage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCloudImageWithHttpInfo($image_locator, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\CloudImage';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AceViral\TeamCity\Model\CloudImage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\CloudInstance, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCloudInstanceWithHttpInfo($instance_locator, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\CloudInstance';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AceViral\TeamCity\Model\CloudInstance',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\CloudProfile, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCloudProfileWithHttpInfo($profile_locator, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\CloudProfile';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AceViral\TeamCity\Model\CloudProfile',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \AceViral\TeamCity\Model\CloudInstance $body body (optional)
     * @param  string $fields fields (optional)
     *
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Start a new cloud instance.
     *
     * @param  \AceViral\TeamCity\Model\CloudInstance $body (optional)
     * @param  string $fields (optional)
     *
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
