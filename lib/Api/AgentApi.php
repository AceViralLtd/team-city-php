...
class AgentApi
{
    ...
    {
        $returnType = '\Swagger\Client\Model\Agent';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AuthorizedInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAuthorizedInfoWithHttpInfo($agent_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\AuthorizedInfo';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AuthorizedInfo',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CompatibilityPolicy, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBuildConfigurationRunPolicyWithHttpInfo($agent_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\CompatibilityPolicy';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CompatibilityPolicy',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\EnabledInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEnabledInfoWithHttpInfo($agent_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\EnabledInfo';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\EnabledInfo',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Compatibilities, HTTP status code, HTTP response headers (array of strings)
     */
    public function getIncompatibleBuildTypesWithHttpInfo($agent_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\Compatibilities';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\Compatibilities',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $agent_locator agent_locator (required)
     * @param  \Swagger\Client\Model\AuthorizedInfo $body body (optional)
     * @param  string $fields fields (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $agent_locator (required)
     * @param  \Swagger\Client\Model\AuthorizedInfo $body (optional)
     * @param  string $fields (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $agent_locator agent_locator (required)
     * @param  \Swagger\Client\Model\CompatibilityPolicy $body body (optional)
     * @param  string $fields fields (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $agent_locator (required)
     * @param  \Swagger\Client\Model\CompatibilityPolicy $body (optional)
     * @param  string $fields (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $agent_locator agent_locator (required)
     * @param  \Swagger\Client\Model\EnabledInfo $body body (optional)
     * @param  string $fields fields (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $agent_locator (required)
     * @param  \Swagger\Client\Model\EnabledInfo $body (optional)
     * @param  string $fields (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
