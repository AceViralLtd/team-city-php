...
class BuildApi
{
     ...
     * @return \Swagger\Client\Model\VcsLabels
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\VcsLabels, HTTP status code, HTTP response headers (array of strings)
     */
    public function addBuildVcsLabelWithHttpInfo($build_locator, $locator = null, $fields = null, $body = null)
    {
        $returnType = '\Swagger\Client\Model\VcsLabels';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\VcsLabels',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ProblemOccurrence
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ProblemOccurrence, HTTP status code, HTTP response headers (array of strings)
     */
    public function addProblemToBuildWithHttpInfo($build_locator, $body = null, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\ProblemOccurrence';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ProblemOccurrence',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\MultipleOperationResult
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\MultipleOperationResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function addTagsToMultipleBuildsWithHttpInfo($build_locator, $body = null, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\MultipleOperationResult';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\MultipleOperationResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\BuildChanges, HTTP status code, HTTP response headers (array of strings)
     */
    public function getArtifactDependencyChangesWithHttpInfo($build_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\BuildChanges';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\BuildChanges',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PinInfo
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PinInfo, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBuildPinInfoWithHttpInfo($build_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\PinInfo';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ProblemOccurrences, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBuildProblemsWithHttpInfo($build_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\ProblemOccurrences';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ProblemOccurrences',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\IssuesUsages, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBuildRelatedIssuesWithHttpInfo($build_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\IssuesUsages';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\IssuesUsages',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\TestOccurrences, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBuildTestOccurrencesWithHttpInfo($build_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\TestOccurrences';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\TestOccurrences',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $build_locator build_locator (required)
     * @param  \Swagger\Client\Model\PinInfo $body body (optional)
     * @param  string $fields fields (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $build_locator (required)
     * @param  \Swagger\Client\Model\PinInfo $body (optional)
     * @param  string $fields (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
