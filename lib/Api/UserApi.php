...
class UserApi
{
     ...
     * Create a new user.
     *
     * @param  \AceViral\TeamCity\Model\User $body body (optional)
     ...
     * Create a new user.
     *
     * @param  \AceViral\TeamCity\Model\User $body (optional)
     * @param  string $fields (optional)
     *
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\User, HTTP status code, HTTP response headers (array of strings)
     */
    public function addUserWithHttpInfo($body = null, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\User';
     ...
     *
     * @param  string $user_locator user_locator (required)
     * @param  \AceViral\TeamCity\Model\Token $body body (optional)
     * @param  string $fields fields (optional)
     *
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AceViral\TeamCity\Model\Token
     */
     ...
     *
     * @param  string $user_locator (required)
     * @param  \AceViral\TeamCity\Model\Token $body (optional)
     * @param  string $fields (optional)
     *
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\Token, HTTP status code, HTTP response headers (array of strings)
     */
    public function addUserTokenWithHttpInfo($user_locator, $body = null, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\Token';
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AceViral\TeamCity\Model\Users
     */
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\Users, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllUsersWithHttpInfo($locator = null, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\Users';
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AceViral\TeamCity\Model\PermissionAssignments
     */
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\PermissionAssignments, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserPermissionsWithHttpInfo($user_locator, $locator = null, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\PermissionAssignments';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AceViral\TeamCity\Model\PermissionAssignments',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AceViral\TeamCity\Model\Tokens
     */
     ...
     * @throws \AceViral\TeamCity\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AceViral\TeamCity\Model\Tokens, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserTokensWithHttpInfo($user_locator, $fields = null)
    {
        $returnType = '\AceViral\TeamCity\Model\Tokens';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AceViral\TeamCity\Model\Tokens',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
