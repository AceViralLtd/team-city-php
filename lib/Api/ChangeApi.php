...
class ChangeApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Changes, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllChangesWithHttpInfo($locator = null, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\Changes';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Change, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChangeWithHttpInfo($change_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\Change';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Issues
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Issues, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChangeIssueWithHttpInfo($change_locator)
    {
        $returnType = '\Swagger\Client\Model\Issues';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\VcsRootInstance, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChangeVcsRootWithHttpInfo($change_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\VcsRootInstance';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\VcsRootInstance',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Commiters
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Commiters, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUniqueCommitersWithHttpInfo($change_locator, $fields = null)
    {
        $returnType = '\Swagger\Client\Model\Commiters';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\Commiters',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
